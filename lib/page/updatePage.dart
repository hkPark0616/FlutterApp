...
class UpdatePage extends StatefulWidget {
  ...
  const UpdatePage({Key? key, required this.contents}) : super(key: key);

  @override
  State<UpdatePage> createState() => UpdateState(contents: contents);
}

class UpdateState extends State<UpdatePage> {
  final dynamic contents;
  UpdateState({required this.contents});
  ...
  void initState() {
    super.initState();
    _loadUserInfo();
    titleController = TextEditingController(text: contents['postTitle']);
    contentController = TextEditingController(text: contents['postContent']);
  }
                        ...
                        return AlertDialog(
                          ...
                          actions: [
                            ...
                            TextButton(
                              ...
                              onPressed: () async {
                                Navigator.of(context).pop();
                                updatePost(contents['postId'],
                                    contents['postNum'], title, content);
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
